            ...
            <fieldset>
                ...
                <div class="custom-toggle-box terms-wrap" :class="isShow?'on':''"> <!-- .on class add -->
                    <div class="inner-scroll-area">
                        <h3>
                            회사는 파트너십을 체결한 크리에이터가 개별적으로 인재를 채용하고자 하는 경우, 채용공고 등록, 지원서 접수 및 관리 업무를 위탁받아 수행하고 있으며, 위탁받은 범위 내에서 아래와 같이 개인정보를 수집 및 이용하고 있습니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오. 이용자는 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 다만 동의를 거부하는 경우 채용 지원 서비스가 제한될 수 있습니다.
                        </h3>
                        ...
                        <ol class="article-list article-1-depth">
                            ...
                            <li>
                                ...
                                <p>회사는 채용절차에 지원하는 지원자의 지원 의사를 확인하고 본인 확인을 하기 위해 개인정보를 수집 및 이용합니다. <br><br>또한 지원자의 중복 지원을 방지하고 서비스를 부정 이용하는 것을 방지하기 위해 개인정보를 수집 및 이용하며, 채용 심사 진행 및 심사 결과 안내, 기타 각종 안내사항이나 고지사항을 전달하기 위해 개인정보를 수집 및 이용합니다. 또한 경력 및 자격사항을 확인하고 채용 관리를 위해 개인정보를 보유합니다.</p>
                            </li>
                            <li>
                                <h4>3. 개인정보 보유기간</h4>
                                <p>회사는 지원자가 개인정보 수집 및 이용에 동의한 날로부터 1년간 개인정보를 보유하면서 채용 절차에 사용합니다. 또한 회사는 개인정보보호법령 등에 따라 특별히 보유하여야 할 필요가 있는 경우에는 법령상 기간을 준수하여 보유하고 있습니다.</p>
                            </li>
                            <li>
                                <h4>4. 개인정보의 파기</h4>
...
<script>
    ...
    export default {
        name: "form-agree-careers-apply-creator",
        props: {
            itemdata: {
                type: Object,
                default: function () {
