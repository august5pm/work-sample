<template>
    <div class="terms-form-wrap">
        <form id="form_1" class="form-group type-outline" action="/">
            <fieldset>
                <legend class="blind">브랜드 광고 제휴 문의를 위한 이용약관 동의 텍스트</legend>
                ...
                <div class="custom-toggle-box terms-wrap" :class="isShow?'on':''"> <!-- .on class add -->
                    <div class="inner-scroll-area">
                        <h3>
                            브랜드 광고 제휴 문의시 회사는 아래와 같이 이용자의 개인정보를 수집 및 이용하고 있습니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오. 이용자는 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 다만 동의를 거부하는 경우 광고 제휴 서비스가 제한될 수 있습니다.
                        </h3>
                        ...
                        <ol class="article-list article-1-depth">
                            ...
                            <li>
                                ...
                                <p>회사는 브랜드 광고 제휴를 신청하는 담당자의 의사를 확인하고 담당자의 신원을 확인하며, 서비스를 부정 이용하는 것을 방지하기 위해 개인정보를 수집 및 이용하며, 제휴 신청에 따른 기타 각종 안내사항이나 고지사항을 전달하기 위해 개인정보를 수집 및 이용합니다. 또한 추후 발생할 수 있는 분쟁 등을 위하여 개인정보를 보유합니다.</p>
                            </li>
                            <li>
                                <h4>3. 개인정보 보유기간</h4>
...
<script>
    ...
    export default {
        name: "form-agree-business-brand-contact",
        props: {
            itemdata: {
                type: Object,
                default: function () {
