<template>
    <div class="terms-form-wrap">
        <form id="form_1" class="form-group type-outline" action="/">
            <fieldset>
                <legend class="blind">크리에이터 지원을 위한 이용약관 동의 텍스트</legend>
                ...
                <div class="custom-toggle-box terms-wrap" :class="isShow?'on':''"> <!-- .on class add -->
                    <div class="inner-scroll-area">
                        <h3>
                            회사는 크리에이터 지원시 아래와 같이 개인정보를 수집 및 이용하고 있습니다. 내용을 자세히 읽으신 후 동의 여부를 결정하여 주십시오. 이용자는 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 다만 동의를 거부하는 경우 크리에이터 지원 신청 서비스가 제한될 수 있습니다.
                        </h3>
                        ...
                        <ol class="article-list article-1-depth">
                            <li>
                                ...
                                <ol>
                                    <li>
                                        <ul>
                                            <li>필수항목 : 이름, 성별, 생년월일, 전화번호(휴대전화번호), 이메일 주소, 유튜브 채널 주소</li>
                                            <li>선택항목 : 유튜브 외 추가 운영 중인 플랫폼 관련 정보</li>
                                        </ul>
                                    </li>
                                </ol>
                            </li>
                            <li>
                                ...
                                <p>회사는 크리에이터로 지원하는 지원자의 지원 의사를 확인하고 본인 확인을 하기 위해 개인정보를 수집 및 이용합니다.
                                    크리에이터 중복 지원을 방지하고 서비스를 부정 이용하는 것을 방지하기 위해 개인정보를 수집 및 이용하며, 크리에이터 지원 심사 및 지원 심사 결과 안내, 기타 각종 안내사항이나 고지사항을 전달하기 위해 개인정보를 수집 및 이용합니다. 또한 추후 발생할 수 있는 분쟁 등을 위하여 개인정보를 보유합니다.
                                </p>
                            </li>
                            <li>
                                <h4>3. 개인정보 보유기간</h4>
                                <p>회사는 지원자가 개인정보 수집 및 이용에 동의한 날로부터 1년간 개인정보를 보유합니다. 위 1년의 기간은 크리에이터 지원자의 지원 의사 확인 및 심사, 모니터링을 위한 기간입니다. 또한 회사는 개인정보보호법령 등에 따라 특별히 보유하여야 할 필요가 있는 경우에는 법령상 기간을 준수하여 보유하고 있습니다.</p>
                            </li>
                            <li>
                                <h4>4. 개인정보의 파기</h4>
                                <p>회사는 지원자가 개인정보 수집 및 이용에 동의한 날로부터 1년간 개인정보를 보유합니다. 위 1년의 기간은 크리에이터 지원자의 지원 의사 확인 및 심사, 모니터링을 위한 기간입니다. 또한 회사는 개인정보보호법령 등에 따라 특별히 보유하여야 할 필요가 있는 경우에는 법령상 기간을 준수하여 보유하고 있습니다.</p>
